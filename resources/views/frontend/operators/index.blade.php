                ...
                @foreach($operators as $operator)
                    <a href="{{ route('operators.show', $operator->slug) }}"
                       class="ns-surface ns-surface--hover p-6 group no-underline flex flex-col">
                        ...
                        <div class="mt-0 rounded-md bg-base-200 border border-base-300 h-24 flex items-center justify-center overflow-hidden px-3">
                            @if($operator->logo)
                        ...
                        <h3 class="mt-4 text-base font-semibold leading-snug text-base-content group-hover:text-primary transition">
                            {{ $operator->name }}
                        </h3>
                        ...
                        <div class="mt-auto pt-4 border-t border-base-300 flex items-center justify-between text-sm">
